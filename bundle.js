...
/***/ function(module, exports, __webpack_require__) {
	...
	var updateEvent = function updateEvent(data) {
	  return $.ajax({
	    url: app.host + '/events/' + data.event.id,
	    method: 'PATCH',
	    headers: {
	      Authorization: 'Token token=' + app.user.token
	    },
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onDeleteEvent = function onDeleteEvent(event) {
	  ...
	  api.deleteEvent(id).done(ui.deleteEventSuccess).fail(ui.failure);
	};

	var onAddEvents = function onAddEvents(event) {
	  event.preventDefault();
	  var data = getFormFields(event.target);
	  api.addEvents(data).done(ui.addEventsSuccess).fail(ui.failure);
	};

	var onShowEvents = function onShowEvents(event) {
	  event.preventDefault();
	  api.showEvents().done(ui.showEventsSuccess).fail(ui.failure);
	};
	...
	var onUpdateEvent = function onUpdateEvent(event) {
	  ...
	  var data = getFormFields(event.target);
	  console.log(data);
	  api.updateEvent(data).done(ui.updateEventSuccess).fail(ui.failure);
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var showEventsSuccess = function showEventsSuccess(data) {
	...
	module.exports = {
	  ...
	  addEventsSuccess: addEventsSuccess,
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
	  ...
	  return "\n  <h5> Band: "
	    + alias4(((helper = (helper = helpers.band || (depth0 != null ? depth0.band : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"band","hash":{},"data":data}) : helper)))
	    + " </h5>\n  <h5> Venue: "
	    ...
	    + " </h5>\n  <h5> Setlist: "
	    + alias4(((helper = (helper = helpers.setlist || (depth0 != null ? depth0.setlist : depth0)) != null ? helper : alias2),(typeof helper === alias3 ? helper.call(alias1,{"name":"setlist","hash":{},"data":data}) : helper)))
	    + " </h5>\n  <h5> Event ID: "
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = __webpack_require__.p + "b68c8abcde72701df426674bec3de093.jpg";
